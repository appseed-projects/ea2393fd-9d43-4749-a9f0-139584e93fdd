...
- Timestamp: `2022-06-02 15:39`
- Build ID: `ea2393fd-9d43-4749-a9f0-139584e93fdd`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ea2393fd-9d43-4749-a9f0-139584e93fdd.git
$ cd ea2393fd-9d43-4749-a9f0-139584e93fdd
```
